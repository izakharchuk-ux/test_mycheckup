  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center flex-1 p-12 text-white"
        ...
        <h2 className="text-3xl font-extrabold mb-3">Join Mycheckups.io</h2>
        <p className="text-white/80 text-lg text-center max-w-sm">Take control of your health journey with AI-powered lab analysis.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-5 py-10 bg-[#F6FBFF]">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-extrabold text-[#0B2A3B] mb-1 text-center">Create account</h1>
          <p className="text-sm text-[#6B7787] text-center mb-7">Start your health journey today</p>

          <div className="flex flex-col gap-4">
            <div>
              <label className="text-xs font-semibold text-[#0B2A3B] mb-1.5 block">Full Name</label>
              <input name="name" value={form.name} onChange={handle} placeholder="Olena K."
            ...
            <div>
              <label className="text-xs font-semibold text-[#0B2A3B] mb-1.5 block">Password</label>
              <div className="relative">
                <input name="password" type={show ? 'text' : 'password'} value={form.password} onChange={handle} placeholder="Min 8 characters"
          ...
          <p className="text-center text-sm text-[#6B7787] mt-5">
            ...
            <Link to="/login" className="text-[#0B7BFF] font-semibold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
